			...
			.extend(
					$.validator,
					{
						...
						messages : {
							...
							numberlength : "Number range should be 10-12",
							ip : "Enter valid IP",
							Alphanumeric : "Please enter Alphanumeric values",
							character : "Please enter Character values",
							digits : "Please enter only digits",
							creditcard : "Please enter valid credit card number",
							equalTo : "Please enter same value again",
							accept : "Please enter value with valid extension.",
							maxlength : $.validator
						...
						methods : {
							...
							phnumber : function(value, element) {
								// return this.optional(element) ||
								// /^\(?(\d{3})\)?[- ]?(\d{3})[- ]?(\d{4})$/;
								// return this.optional(element) ||
