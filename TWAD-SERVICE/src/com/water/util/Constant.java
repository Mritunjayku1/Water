...
public class Constant {
	...
	public static final String Get_PaymentDashboardCount="select * from (select count(*) as approvedApplication from CompanyDtl where OFFICE_ID is not null ) as b, (select count(*) as rejectedApplication from CompanyDtl where ACTIVE=0 ) as c, (select count(*) as pendingApplication from CompanyDtl where OFFICE_ID is null ) as d";
	public static final String Get_EEDashboardCount="select * from (select count(*) as applicationFeePending from CompanyDtl where EE_STATUS=1 and ACTIVE=2 ) as b, (select count(*) as upfrontChargesPending from CompanyDtl where EE_STATUS=2 and ACTIVE=2 ) as c, (select count(*) as fullPaymentPending from CompanyDtl where EE_STATUS=3 and ACTIVE=2 ) as d";
