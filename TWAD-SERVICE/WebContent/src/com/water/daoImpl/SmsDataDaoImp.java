...
public class SmsDataDaoImp implements SmsDatadao {
	...
	@Override
	public List<Application> getTemplateID(Integer applicationId,Integer smsType) {
		Session session = sessionfact.openSession();
	//	StringBuffer sqlQreyString = new StringBuffer();

		/*List<Object[]> SmsTemplate = new ArrayList<Object[]>();
		sqlQreyString.append(Constant.Get_SMSTemplate);
		SQLQuery query = session.createSQLQuery(sqlQreyString.toString());
		query.setParameter("applicationId", applicationId);
		query.setResultTransformer(new AliasToBeanResultTransformer(SmsBean.class));
		SmsTemplate = query.list();*/
