...
(function() {
	/*
	 * Chosen source: generate output using 'cake build' Copyright (c) 2011 by
	 * Harvest
	...
	Chosen = (function() {
			...
			if (this.is_multiple) {
				container_div
						.html('<ul class="chzn-choices"><li class="search-field"><input type="text" value="'
								+ this.default_text
								+ '" class="default" autocomplete="off" style="width:125px;" /></li></ul><div class="chzn-drop" style="left:-9000px;z-index:10000;"><ul class="chzn-results"></ul></div>');
			} else {
				container_div
						.html('<a href="javascript:void(0)" class="chzn-single"><span>'
								+ this.default_text
								+ '</span><div><b></b></div></a><div class="chzn-drop" style="left:-9000px;z-index:10000;"><div class="chzn-search" style="z-index:1000;"><input type="text" autocomplete="off" style="z-index:10001;" /></div><ul class="chzn-results"></ul></div>');
			}
		...
		Chosen.prototype.results_build = function() {
			...
			startTime = new Date();
			this.parsing = true;
			this.results_data = root.SelectParser
		...
		Chosen.prototype.result_add_group = function(group) {
			if (!group.disabled) {
				...
				return '<li id="' + group.dom_id + '" class="group-result">'
						+ $("<div />").text(group.label).html() + '</li>';
			} else {
				return "";
			}
		};
		Chosen.prototype.result_add_option = function(option) {
			...
			if (!option.disabled) {
				...
				classes = option.selected && this.is_multiple ? []
						: [ "active-result" ];
				if (option.selected) {
				...
				return '<li id="' + option.dom_id + '" class="'
						+ classes.join(' ') + '">' + option.html + '</li>';
			} else {
				return "";
			}
		};
		...
		Chosen.prototype.results_show = function() {
			...
			dd_top = this.is_multiple ? this.container.height()
		...
		Chosen.prototype.choices_click = function(evt) {
			evt.preventDefault();
			if (this.active_field
					&& !($(evt.target).hasClass("search-choice"
					...
					if (option.group) {
						...
						if (found) {
							if (searchText.length) {
								...
								text = option.html.substr(0, startpos
										+ searchText.length)
										+ '</em>'
							...
							if (this.result_highlight
									&& result_id === this.result_highlight
											.attr('id')) {
								this.result_clear_highlight();
							}
		...
		Chosen.prototype.winnow_results_clear = function() {
			...
			for (_i = 0, _len = lis.length; _i < _len; _i++) {
				...
				li = $(li);
				_results
						.push(li.hasClass("group-result") ? li.show()
								: !this.is_multiple
										|| !li.hasClass("result-selected") ? this
										.result_activate(li)
										: void 0);
			}
			return _results;
		...
		Chosen.prototype.keydown_arrow = function() {
			...
			if (!this.result_highlight) {
				first_active = this.search_results.find("li.active-result")
						.first();
				if (first_active) {
