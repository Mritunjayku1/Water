                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <c:forEach items="${list.officeDtl}" var="office" varStatus="count">
                                        <option value="${office.getOfficeId()}">${office.getOfficeName()}</option>
                                              ...
                                              <td class="center">
                                              <button class="paymentClass" id="approved_${app.getAppId()}" name="approvedBtn" style="width: auto;">Approved</button>
											  <button class="cancelbtn" id="rejected_${app.getAppId()}" name="rejectedBtn" style="width: auto;">Rejected</button>
											  </td>
