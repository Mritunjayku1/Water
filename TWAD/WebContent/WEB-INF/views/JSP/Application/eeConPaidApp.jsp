...
<script type="text/javascript">
	...
	function SendOracleDB(app) {
				
		var commissiningdate = document.getElementById('commissiningdate').value;
		var completionDate = document.getElementById('completionDate').value;
		
		 if (commissiningdate == null || commissiningdate == '') {
				alert("Please select the  commissiningdate date !");
				return false;
			}
		
		 if (completionDate == null || completionDate == '') {
				alert("Please select the completionDate!");
				return false;
			}
		...
		$.ajax({
			...
			data : {
				'appRef' : app.id,
				'commissiningdate' : commissiningdate,
				'completionDate' : completionDate,
				'estimationCost' : app.estimationCost,
...
<table class='table-bordered table table-striped display'
	...
	<tr>
		<td colspan='8'
			...
			Application Payment Paid Details</td>
	</tr>
</table>
									...
									<c:forEach items="${list.appBean}" var="app">
										...
										<tr class="odd gradeX">
											...
											<td><button onclick="getPaymentDetails(this.id)"
													...
													style="width: auto;"><font color="white">Completion / Commissioning Date</font></button>
												...
												<div class="imgcontainer">
													...
													<table id="id01" class="modal" style="display: none;">
														...
														<tr>
														<tr>
															<td><label><b>Completion Date</b></label></td>
															<td><input type="text" name="remarks" readonly
																id="completionDate" placeholder="dd-mm-yyyy"
																class="inspectionDate" style="width: 130px !important;"
																value="" /></td>
														</tr>
														<tr>
															<td><label><b>Commissonning Date</b></label></td>
															<td><input type="text" name="remarks" readonly
																id="commissiningdate" placeholder="dd-mm-yyyy"
																class="inspectionDate" style="width: 130px !important;"
																value="" /></td>
														</tr>
														<tr>
															...
															<td align="center" colspan="1">
																<!-- <button class="paymentClass" id="uploadbtn"
																	style="width: auto;">Upload Document...</button> -->
																<button onclick="SendOracleDB({'id':'${app.getAppId()}','estimationCost':'${app.getEstimationCost()}','initialFee':'${app.getInitialPayment()}','gst':'${app.getGstAmount()}','totalAmount':'${app.getTotalAmount()}'})" 
																	class="paymentClass" id="${app.getAppId()}"
