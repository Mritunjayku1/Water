...
*/
			...
			if(app.getPaidProcessFee()!=null)
			{
			smsdtls.put("InitialPayment", app.getPaidProcessFee());
			}
			if(app.getPaidfinalFee()!=null)
			{
			smsdtls.put("PaidfinalFee", app.getPaidfinalFee().toString());
			}
			if(app.getFixedFinalFee()!=null)
			{
			smsdtls.put("FixedFinalFee", app.getFixedFinalFee().toString());
			}
			...
			try {
				...
				//	params.put("InitialPayment", app.getInitialPayment());
					...
					if(app.getPaidProcessFee()!=null)
					{
						params.put("InitialPayment", app.getPaidProcessFee());
					}
					if(app.getFixedFinalFee()!=null)
					{
						params.put("FixedFinalFee", app.getFixedFinalFee().toString());
