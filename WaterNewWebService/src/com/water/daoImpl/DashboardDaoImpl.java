...
public class DashboardDaoImpl implements DashboardDao {
	...
	@Override
	public List<Application> listBeforeInspection() {
		// TODO Auto-generated method stub
	...
	@Override
	public List<Application> listAfterInspection() {
		// TODO Auto-generated method stub
		...
		try {
			Criteria cr = session.createCriteria(Application.class,"app")
					.createCriteria("app.eeStatus","status")
			         .add(Restrictions.eq("status.statusId", 2))
					.add(Restrictions.eq("app.statusFlag", 'Y')).add(Restrictions.isNotNull("app.paidProcessFee")).add(Restrictions.eq("app.insStatusId",2 ));
