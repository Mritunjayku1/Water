...
<td valign="top" align="center" style="width: 100%;height: 410px;">
    <div style="width: 460px; margin-top: 50px;">
				...
				<ul style="margin-top: 0px !important; list-style-type: none; padding: 0px">
					...
					<li class="dropdown-slide" id="companyLogin" style="background-color: #FED367; width: 100%; border-bottom: 2px solid #fff; border-right: none !important;"><a href="/WaterNew/formRegister.do" class="dropdown-toggle" data-toggle="dropdown">
					...
					<li class="dropdown-slide" style="background-color: #FED367; width: 100%; border-bottom: 2px solid #fff; border-right: none !important;"><a href="/WaterNew/adminLogin.do" class="dropdown-toggle" data-toggle="dropdown">
							<table style="width: 100%;" id="departmentLogin">
								<tbody>
									<tr>
										...
										<td style="width: 5%;"></td>
										<td style="width: 70%;" class="menu_multi_line"><span style="font-size: 16px; color: Black;"> <span id="Label2">CMWSSB Login</span></span></td>
										<td style="width: 5%;" align="center"></td>
									</tr>
								</tbody>
							</table>
					</a></li>
					<li class="dropdown-slide" style="background-color: #FED367; width: 100%; border-bottom: 2px solid #fff; border-right: none !important;"><a href="/WaterNew/checkApplicationStatus.do?appId=" class="dropdown-toggle" data-toggle="dropdown">
					...
					<li class="dropdown-slide" style="background-color: #FED367; width: 100%; border-bottom: 2px solid #fff; border-right: none !important;"><a href="/WaterNew/initialPayment.do" class="dropdown-toggle" data-toggle="dropdown">
	...
	<div class="loginDialog" id="companyLoginDialog">
		...
		<p style="padding-left: 30px;">
			New User? <a href="/WaterNew/formRegister.do">Click here</a>
		</p>
	</div>
