...
<div>
	<ul id="HDropdown-orange-classic">
	 ...
	 <li><a href="ceDashboard.do" id='menu1' > Dashboard</a>  
		
		<!-- <li><a href="#" class="dashboard" id='menu1' > Dashboard</a>  -->
		
		<li><a href="ceViewApp.do" id='menu2'>Pending Application</a>
		<li><a href="ceApproved.do" id='menu2'>Approved Application</a>
			
		</li>
			<li><a href="ceViewAll.do" id='menu2'>View All Application </a> 			
