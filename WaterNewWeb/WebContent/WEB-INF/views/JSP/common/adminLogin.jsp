...
<BODY> 
		...
		<img src='library/img/EC_logo.jpg' width="70px" height="70px"><font color="blue">  New Water Connections(Industries)</font> 	
				...
				<DIV class="inner">
					...
					<DIV class=""> 
						<DIV class="form-group">
							<form:input path="LoginName" autocomplete="off" autofocus="true" class="form-control" id="username" placeholder="User Name" required="true" />
						</DIV>
					</DIV>
					<DIV class="">
						<DIV class="form-group  ">
