...
<tr><td align="left" colspan="2"><b>Paid Amount<font style="color: rgb(128,128,128);font-size: 12px;">(GST @ 18 % Included)</font></b></td><td colspan="2">:<span>${paidAmount}</span></td></tr>
...
<table width="80%" align="right" style="font-size: 15px;">
...
<form action="/WaterNew/downloadPDF.do" id="imageFormId" method="post">
