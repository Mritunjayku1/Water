...
<tr height="70px" style="font-weight: bold;"><td align="center"><input type="button" id="load" value="Download Ack"/></td>
<td><input type="button"
				id="printbtnId" onclick="javascript:window.print();"
				name="industrialistSubmitBtn" value="Print Ack" /></td></tr>
<tr><td align="center"><a href="/WaterNew/index.do"><b>Back to Home Page</b> </a></td></tr>
</table>
